...
import ml.socshared.auth.domain.request.SendMessageGeneratingCodeRequest;
...
public interface MailSenderClient {
    ...
    @PostMapping(value = "/api/v1/private/message/confirm/mail", produces = MediaType.APPLICATION_JSON_VALUE,
            consumes = MediaType.APPLICATION_JSON_VALUE)
    SuccessResponse sendMailConfirm(@RequestBody SendMessageGeneratingCodeRequest request, @RequestHeader("Authorization") String token);

    @PostMapping(value = "/api/v1/private/message/password/reset", produces = MediaType.APPLICATION_JSON_VALUE,
            consumes = MediaType.APPLICATION_JSON_VALUE)
    SuccessResponse sendPasswordReset(@RequestBody SendMessageGeneratingCodeRequest request, @RequestHeader("Authorization") String token);
